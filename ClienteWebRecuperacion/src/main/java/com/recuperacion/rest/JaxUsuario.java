...
public class JaxUsuario {

	//Puerto establecido para el gateway
	String enlace= "http://127.0.0.1:9999/usuario/";
	...
	public List<Usuario> buscarTodos() {
		...
		return getListadoTotal2.readEntity(new GenericType<List<Usuario>>() {});
	}
	
	public Usuario buscar(int id) {	
		ResteasyWebTarget getOpcion2 = client.target(enlace+id);
		Response getOp2 = getOpcion2.request().get();
		return getOp2.readEntity(Usuario.class);     
	}
}
